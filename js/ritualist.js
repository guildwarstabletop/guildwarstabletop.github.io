$(document).ready(function() {
	...
	// Ritualist navigation
	$('#traits_tab').click(function() {
		$('#tab_label').html("TRAITS");

		$(this).css('background-color', '#222222');
		$('#attributes_tab').css('background-color', '#21dcc0');
		$('#tips_tab').css('background-color', '#21dcc0');
	...
	$('#attributes_tab').click(function() {			
		...
		$('#traits_tab').css('background-color', '#21dcc0');
		$(this).css('background-color', '#222222');
		$('#tips_tab').css('background-color', '#21dcc0');
	...
	$('#spawning_power').hover(function() {
		$(this).css('color', '#21dcc0');
		$('#channeling_magic').css('color', '#222222');
		$('#communing').css('color', '#222222');
		$('#restoration_magic').css('color', '#222222');
	...
	$('#channeling_magic').hover(function() {
		$('#spawning_power').css('color', '#222222');
		$(this).css('color', '#21dcc0');
		$('#communing').css('color', '#222222');
		$('#restoration_magic').css('color', '#222222');
	...
	$('#restoration_magic').hover(function() {
		$('#spawning_power').css('color', '#222222');
		$('#channeling_magic').css('color', '#222222');
		$('#communing').css('color', '#222222');
		$(this).css('color', '#21dcc0');
